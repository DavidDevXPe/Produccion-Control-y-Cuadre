...
const seedNames = [
  ...
  [
    "REJO REPRODUCTOR CRUDO CONGELADO BLOCK S/TTO S/U S/V C/T 50 cm - 70 cm 100% P.N.",
    "REPRODUCTOR",
  ],
  [
    "MANTO ESTANDAR CRUDO CONGELADO BLOCK S/TTO C/02 MEMB 2 KG - 4 KG SB 100% P.N.",
    "MANTO",
  ],
  [
    "MANTO ESTANDAR CRUDO CONGELADO BLOCK S/TTO C/02 MEMB 2 KG - 4 KG CH 100% P.N.",
    "MANTO",
  ],
  [
  ...
  [
    "MANTO JAPONES CRUDO CONGELADO BLOCK S/TTO 1 KG - 2 KG SB 100% P.N.",
    "MANTO",
  ],
  ["ALETA CRUDA CONGELADA BLOCK S/TTO 3000 g - 4000 g 100% P.N.", "ALETA"],
  ...
  ["BOTON ESPAÑA SM SP ST (TRATAMIENTO)", "BOTON"],
  [
    "REJOS CRUDOS CONGELADOS BLOCK S/TTO BAILARINA S/R 500 G - 1000 G SEMI LIMPIOS 100% P.N.",
    "REJOS",
  ],
  [
  ...
  [
    "ANILLAS CRUDAS CONGELADAS BLOCK S/TTO ESPAÑA CM 2DA MIXTA 100% P.N.",
    "ANILLAS",
  ],
  [
  ...
  [
    "RECORTE CRUDO CONGELADO BLOCK S/TTO ANILLAS CM SP ST 100% P.N.",
    "RECORTE_CRUDO",
  ],
  [
  ...
  [
    "RECORTES CRUDOS - LABIOS CONGELADOS BLOCK S/TTO 100% P.N.",
    "RECORTE_CRUDO",
  ],
  ["RECORTE COCIDO CONGELADO BLOCK S/TTO PB 100% P.N.", "RECORTE_COCIDO"],
  ["PANZA BALLENA COCIDA", "RECORTE_COCIDO"],
...
function technicalClassification(
  canonicalName: string,
): NonNullable<ProductionCatalogItem["technicalClassification"]> {
...
export const SEED_CAPTURE_PRODUCTS: readonly ProductionCatalogItem[] =
  seedNames.map(([canonicalName, family], index) => ({
